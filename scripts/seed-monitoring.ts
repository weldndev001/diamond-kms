...
// Run with: npx ts-node --compiler-options '{"module":"CommonJS"}' scripts/seed-monitoring.ts
...
const demoInstances = [
    {
        ...
        app_version: '2.1.0',
        status: 'online',
        last_heartbeat: new Date(Date.now() - 3 * 60000), // 3 min ago
        cpu_percent: 62,
        memory_percent: 48,
        disk_percent: 78,
        uptime_seconds: 1314000,
        db_status: 'connected',
        db_size_mb: 2340,
        db_connections: 12,
        total_users: 45,
        ...
        ai_status: 'healthy',
        ai_avg_response_ms: 2300,
        ai_success_rate: 97.2,
        ai_tokens_30d: 124500,
        embedding_total: 234,
        embedding_done: 231,
        embedding_failed: 1,
        dau_today: 28,
        chat_sessions_7d: 156,
        quiz_completions_7d: 34,
        read_rate: 78,
        avg_quiz_score: 82,
        approval_pending: 3,
        errors_total_24h: 7,
        ...
        license_expires: new Date('2027-01-15'),
    },
    {
        ...
        license_plan: 'pro',
        license_expires: new Date('2026-06-01'),
    },
    {
        ...
        ai_status: 'degraded',
        ai_avg_response_ms: 5100,
        ai_success_rate: 72,
        ai_tokens_30d: 203000,
        embedding_total: 456,
        embedding_done: 443,
        embedding_failed: 8,
        dau_today: 45,
        chat_sessions_7d: 678,
        quiz_completions_7d: 8,
        read_rate: 45,
        avg_quiz_score: 65,
        approval_pending: 12,
        errors_total_24h: 20,
        ...
        latest_errors: [
            ...
            { level: 'WARN', source: 'System', message: 'Disk usage at 91% — critical threshold', created_at: new Date(Date.now() - 60 * 60000).toISOString() },
        ],
        license_plan: 'enterprise',
        license_expires: new Date('2027-03-20'),
    },
    {
        ...
        app_version: '1.9.0',
        status: 'offline',
        last_heartbeat: new Date(Date.now() - 6 * 3600000), // 6 hours ago
        cpu_percent: 0,
        memory_percent: 0,
        disk_percent: 0,
        uptime_seconds: 0,
        ...
        latest_errors: [],
        license_plan: 'basic',
        license_expires: new Date('2026-04-15'),
    },
    {
        ...
        embedding_failed: 0,
        dau_today: 18,
        chat_sessions_7d: 210,
        quiz_completions_7d: 22,
        read_rate: 85,
        avg_quiz_score: 79,
        approval_pending: 1,
        errors_total_24h: 3,
        ...
        license_plan: 'enterprise',
        license_expires: new Date('2027-06-30'),
    },
    {
        ...
        latest_errors: [],
        license_plan: 'pro',
        license_expires: new Date('2026-12-31'),
    },
]
...
async function main() {
    ...
    for (const inst of demoInstances) {
        ...
        console.log(`  ✅ ${inst.client_name} (${inst.status})`)
    }

    console.log(`\n🎉 Done! ${demoInstances.length} client instances seeded.`)
}
